...
exports.deleteUserInRoom = exports.updateScore = exports.getAllUsersInRoom = exports.enterRoom = exports.closeRoom = exports.deleteRoom = exports.createRoom = exports.getRoomById = exports.getUserScoreInRoom = exports.getAllOpenRooms = void 0;
...
const getUserScoreInRoom = async (event) => {
    let connection = null;
    try {
        connection = await promise_1.default.createConnection(dbConfig);
...
exports.getUserScoreInRoom = getUserScoreInRoom;
const getRoomById = async (event) => {
    var _a;
    let connection = null;
    try {
        connection = await promise_1.default.createConnection(dbConfig);
...
const updateScore = async (event) => {
    ...
    try {
      ...
      WHERE room_id = ?, user_id = ?`;
        const [roomUserRows] = (await connection.query(checkRoomSql, [roomId, userId]));
        if (!roomRows) {
            return {
                statusCode: 404,
                body: JSON.stringify({
        ...
        const numScored = roomUserRows[0].num_scored;
        const originalScore = roomUserRows[0].score;
